...
export default function SettingsPage() {
  ...
  return <main className="settings-page">
    ...
    <div className="settings-layout">
      <nav className="settings-nav" aria-label="设置分组"><a href="#general">通用</a><a href="#notifications">通知</a><a href="#security">新会话与安全</a><a href="#data">数据</a><a href="#about">关于</a></nav>
