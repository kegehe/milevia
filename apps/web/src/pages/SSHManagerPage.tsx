...
export default function SSHManagerPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setShowForm(false); updateForm({ name: "", host: "", port: 22, user: "", privateKeyPath: "", authMethod: "key", password: "", rootPath: "", profileName: "" }); void loadConnections();
  ...
  const closeForm = () => {
    setShowForm(false);
    updateForm({ name: "", host: "", port: 22, user: "", privateKeyPath: "", authMethod: "key", password: "", rootPath: "", profileName: "" });
