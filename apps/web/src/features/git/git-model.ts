...
export type GitOperation = { id: string; projectId: string; type: string; status: string; requestSummary: string; beforeState: string; afterState: string; errorCode?: string; errorMessage?: string; requestedAt: string; startedAt?: string; finishedAt?: string };
