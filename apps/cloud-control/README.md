...
接口：`/health`、`/v1/instances`、`/v1/instances/{instanceId}/overview`、`/v1/instances/{instanceId}/snapshot`、`/v1/instances/{instanceId}/commands`、`/v1/instances/{instanceId}/revoke`、`/v1/commands/{commandId}`、`/v1/events?instanceId=...`、`/v1/agent/connect?instanceId=...`、`/v1/agent/events`。
